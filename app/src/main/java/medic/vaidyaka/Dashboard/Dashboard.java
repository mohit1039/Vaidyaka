package medic.vaidyaka.Dashboard;
...
import medic.vaidyaka.Common.Common;
import medic.vaidyaka.Distresscall;
...
public class Dashboard extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        db.child(Objects.requireNonNull(auth.getUid())).addValueEventListener(new ValueEventListener() {
            @Override
    ...
    public void showvisitor(View view) {
        ...
        String number = ("tel:"+Common.register.getDocphone());
